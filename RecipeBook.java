...
public class RecipeBook{
    ...
    while(true){
      ...
      try {
        ...
        // TODO: View all recipes
          ...
          showAll();
          System.out.println("Would you like to view a recipe's details? (yes/no) ");
          String recipeDetails = scanner.nextLine();
          if (recipeDetails.equalsIgnoreCase("yes")){
            System.out.println("Please enter the recipe's corresponding number: ");
  ...
  public static void addRecipe(){
    try{
      ...
      Recipe r = new Recipe(name, description, ingredients, instructionsArray, (current_num + 1));
      if (book.add(r)){
  ...
  private static void preloadedRecipes(){
    String[] instructions = new String[]{"Cook spaghetti in boiling water", "melt butter in medium frying pan", "add black pepper to butter", "drain pasta but keep some pasta water", "add pasta and pasta water to pan with butter and pepper"};
    ...
    Recipe r = new Recipe("Cacio e pepe", "butter and pepper spaghetti dish", "spaghetti, butter, ground black pepper, grated pecorino or parmesan", instructions, 1);
    book.add(r);
    Recipe r2 = new Recipe("cake2", "popular dessert", "eggs2, butter2", instructions2, 2);
    book.add(r2);
    Recipe r3 = new Recipe("cake3", "popular dessert", "eggs3, butter3", instructions3, 3);
    book.add(r3);
  }
  ...
  private static void showRecipeInfo(String name){
    ...
    System.out.println("Enter 0 to view the recipe in its entirety or enter 1 to view the recipe's instructions step-by-step: ");
      ...
      if (view_choice == 0){
        ...
        System.out.println("Instructions: (Please hit enter to see next instruction) \n");
        for (Recipe x : book){
          if (name.equalsIgnoreCase(x.name)){
            int instr_count = 1; 
            for (String instr : x.instructions)
